...
fun main() {
    ...
    println("2. Возраст питомца 1.5, 3 и 8")
...
fun getFilm(age: Int): String {
    return if (age < 0 || age > 150) {
        ...
        if (age in 1 until 12) {
             "Детский"
         } else if (age in 12 until 18) {
             "Подростковый"
         } else {
             "Взрослый"
         }
